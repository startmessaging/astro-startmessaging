...
This means you get full DLT compliance without any of the registration burden. No DLT entity registration, no template approvals, no operator portals, no waiting.
...
Sign up at [app.startmessaging.com](https://app.startmessaging.com) with your email, then complete the one-time KYC step in onboarding by uploading either a company registration document or a personal government ID. No DLT entity registration or template approvals needed.
...
<Accordion>
  <AccordionItem title="Do I need any documents to sign up?">
    You sign up with just an email address, but before you can send live messages, onboarding asks for a one-time KYC: upload either a company registration document (for businesses) or a personal government ID (for individuals and solo developers). That is the only paperwork — there is no DLT entity registration, no template approvals, and no operator portal to deal with.
  </AccordionItem>
